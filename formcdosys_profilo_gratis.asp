...
if Request.Form("check_send") = "" then
	...
	With iMsg
	  Set .Configuration = iConf
	   ...
	   .HTMLBody = "<img src='http://www.trovoperte.com/images/logo_trovoperte.png' alt='logo Trovo x Te' style='float: center' /><br><br><font face=verdana size=2>Buongiorno " & nome & " " & cognome & ", <br>abbiamo ricevuto la tua richiesta, sarai ricontattato al pi&ugrave; presto da un nostro operatore.<br><br>Grazie e arrivederci.<br><br><br><br> Questi i dati inseriti nel modulo presente alla pagina <b> " & modulo & " </b><br><br>" & corpoMessaggio 
	   .Send
	End With
    ...
    <div class="txtwrapper">
        ...
        <div data-role="page" id="page_index">
            ...
            <div data-role="main"  data-backbtn="false">
                <p style="text-align:center">Grazie per averci contattato!<br />La sua richiesta di iscrizione è stata inviata correttamente, le risponderemo appena possibile.
                <br /><br /><br />

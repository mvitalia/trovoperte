...
if tipologia <> "" then
    Dim sqlNewsPromo
        ...
        if tipologia = "categorie" then
            sqlNewsPromo = "SELECT app_categorie.ID, app_categorie.titolo FROM app_categorie, app_macrocategorie WHERE app_categorie.ID_macrocategoria = app_macrocategorie.ID and app_macrocategorie.ID = '" & macrocategoria & "'"
